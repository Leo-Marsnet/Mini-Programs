...
$root.ModelCos = (function () {
  ...
  ModelCos.encode = function encode(message, writer) {
    ...
    if (message.modelList != null && message.modelList.length)
      for (var i = 0; i < message.modelList.length; ++i)
        $root.ModelCos.ModelCosId.encode(
          message.modelList[i],
  ...
  ModelCos.decode = function decode(reader, length) {
    ...
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ModelCos();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          if (!(message.modelList && message.modelList.length)) message.modelList = [];
  ...
  ModelCos.verify = function verify(message) {
    ...
    if (message.modelList != null && message.hasOwnProperty('modelList')) {
      if (!Array.isArray(message.modelList)) return 'modelList: array expected';
      for (var i = 0; i < message.modelList.length; ++i) {
        var error = $root.ModelCos.ModelCosId.verify(message.modelList[i]);
        if (error) return 'modelList.' + error;
      }
    }
    return null;
  };
  ...
  ModelCos.fromObject = function fromObject(object) {
    if (object instanceof $root.ModelCos) return object;
    var message = new $root.ModelCos();
    if (object.modelList) {
      if (!Array.isArray(object.modelList)) throw TypeError('.ModelCos.modelList: array expected');
      message.modelList = [];
  ...
  ModelCos.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.modelList = [];
  ...
  ModelCos.ModelCosId = (function () {
    ...
    ModelCosId.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ModelCos.ModelCosId();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    ModelCosId.verify = function verify(message) {
      ...
      if (message.modelCosid != null && message.hasOwnProperty('modelCosid'))
        if (!$util.isString(message.modelCosid)) return 'modelCosid: string expected';
    ...
    ModelCosId.fromObject = function fromObject(object) {
      if (object instanceof $root.ModelCos.ModelCosId) return object;
      ...
      if (object.modelCosid != null) message.modelCosid = String(object.modelCosid);
    ...
    ModelCosId.toObject = function toObject(message, options) {
      ...
      if (message.modelType != null && message.hasOwnProperty('modelType'))
        object.modelType =
          options.enums === String ? $root.enARModelType[message.modelType] : message.modelType;
      if (message.modelCosid != null && message.hasOwnProperty('modelCosid'))
...
$root.ARModel = (function () {
  ...
  ARModel.verify = function verify(message) {
    ...
    if (message.cosid != null && message.hasOwnProperty('cosid'))
      if (!$util.isString(message.cosid)) return 'cosid: string expected';
    if (message.bizuin != null && message.hasOwnProperty('bizuin'))
      if (!$util.isInteger(message.bizuin)) return 'bizuin: integer expected';
    if (message.name != null && message.hasOwnProperty('name'))
      if (!$util.isString(message.name)) return 'name: string expected';
    if (message.uploadTime != null && message.hasOwnProperty('uploadTime'))
      if (!$util.isInteger(message.uploadTime)) return 'uploadTime: integer expected';
    ...
    if (message.modelCos != null && message.hasOwnProperty('modelCos')) {
      ...
      if (error) return 'modelCos.' + error;
    }
    return null;
  };
  ...
  ARModel.fromObject = function fromObject(object) {
    if (object instanceof $root.ARModel) return object;
    var message = new $root.ARModel();
    if (object.cosid != null) message.cosid = String(object.cosid);
    if (object.bizuin != null) message.bizuin = object.bizuin >>> 0;
    if (object.name != null) message.name = String(object.name);
    if (object.uploadTime != null) message.uploadTime = object.uploadTime >>> 0;
  ...
  ARModel.toObject = function toObject(message, options) {
    ...
    if (message.cosid != null && message.hasOwnProperty('cosid')) object.cosid = message.cosid;
    if (message.bizuin != null && message.hasOwnProperty('bizuin')) object.bizuin = message.bizuin;
    if (message.name != null && message.hasOwnProperty('name')) object.name = message.name;
    if (message.uploadTime != null && message.hasOwnProperty('uploadTime'))
      object.uploadTime = message.uploadTime;
    if (message.modelStatus != null && message.hasOwnProperty('modelStatus'))
      object.modelStatus =
        options.enums === String ? $root.enARModelStatus[message.modelStatus] : message.modelStatus;
    if (message.algoType != null && message.hasOwnProperty('algoType'))
      object.algoType =
        options.enums === String ? $root.enARAlgorithmType[message.algoType] : message.algoType;
    if (message.modelCos != null && message.hasOwnProperty('modelCos'))
...
$root.GetARModelListReq = (function () {
  ...
  GetARModelListReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GetARModelListReq();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GetARModelListReq.verify = function verify(message) {
    ...
    if (message.bizuin != null && message.hasOwnProperty('bizuin'))
      if (!$util.isInteger(message.bizuin)) return 'bizuin: integer expected';
    if (message.modelStatus != null && message.hasOwnProperty('modelStatus'))
      if (!$util.isInteger(message.modelStatus)) return 'modelStatus: integer expected';
    if (message.startTime != null && message.hasOwnProperty('startTime'))
      if (!$util.isInteger(message.startTime)) return 'startTime: integer expected';
    if (message.endTime != null && message.hasOwnProperty('endTime'))
      if (!$util.isInteger(message.endTime)) return 'endTime: integer expected';
    ...
    if (message.algoType != null && message.hasOwnProperty('algoType'))
      if (!$util.isInteger(message.algoType)) return 'algoType: integer expected';
    return null;
  };
  ...
  GetARModelListReq.fromObject = function fromObject(object) {
    if (object instanceof $root.GetARModelListReq) return object;
    var message = new $root.GetARModelListReq();
    if (object.bizuin != null) message.bizuin = object.bizuin >>> 0;
    if (object.modelStatus != null) message.modelStatus = object.modelStatus >>> 0;
    ...
    if (object.algoType != null) message.algoType = object.algoType >>> 0;
    return message;
  };
...
$root.GetARModelListResp = (function () {
  ...
  GetARModelListResp.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GetARModelListResp();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GetARModelListResp.fromObject = function fromObject(object) {
    if (object instanceof $root.GetARModelListResp) return object;
...
$root.GenerateARModelReq = (function () {
  ...
  GenerateARModelReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GenerateARModelReq();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GenerateARModelReq.verify = function verify(message) {
    ...
    if (message.lod != null && message.hasOwnProperty('lod'))
      if (!$util.isInteger(message.lod)) return 'lod: integer expected';
    if (message.getmesh != null && message.hasOwnProperty('getmesh'))
      if (typeof message.getmesh !== 'boolean') return 'getmesh: boolean expected';
    if (message.gettexture != null && message.hasOwnProperty('gettexture'))
      if (typeof message.gettexture !== 'boolean') return 'gettexture: boolean expected';
    return null;
  };
  ...
  GenerateARModelReq.fromObject = function fromObject(object) {
    if (object instanceof $root.GenerateARModelReq) return object;
    ...
    if (object.buffer != null)
      if (typeof object.buffer === 'string')
        $util.base64.decode(
          object.buffer,
          (message.buffer = $util.newBuffer($util.base64.length(object.buffer))),
          0
        );
    ...
    if (object.lod != null) message.lod = object.lod >>> 0;
    if (object.getmesh != null) message.getmesh = Boolean(object.getmesh);
    if (object.gettexture != null) message.gettexture = Boolean(object.gettexture);
    return message;
  };
  ...
  GenerateARModelReq.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      ...
      if (options.bytes === String) object.buffer = '';
        ...
        object.buffer = [];
        if (options.bytes !== Array) object.buffer = $util.newBuffer(object.buffer);
      }
      object.url = '';
      object.algoType = options.enums === String ? 'Algorithm_Type_3D_Object' : 1;
      object.lod = 0;
    ...
    if (message.algoType != null && message.hasOwnProperty('algoType'))
      object.algoType =
        options.enums === String ? $root.enARAlgorithmType[message.algoType] : message.algoType;
    if (message.lod != null && message.hasOwnProperty('lod')) object.lod = message.lod;
    if (message.getmesh != null && message.hasOwnProperty('getmesh'))
...
$root.GenerateARModelResp = (function () {
  ...
  GenerateARModelResp.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GenerateARModelResp();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GenerateARModelResp.fromObject = function fromObject(object) {
    if (object instanceof $root.GenerateARModelResp) return object;
...
$root.ARModelData = (function () {
  ...
  ARModelData.verify = function verify(message) {
    ...
    if (message.meshModel != null && message.hasOwnProperty('meshModel'))
      if (
        !(
          (message.meshModel && typeof message.meshModel.length === 'number') ||
          $util.isString(message.meshModel)
        )
      )
    ...
    if (message.textureModel != null && message.hasOwnProperty('textureModel'))
      if (
        !(
          (message.textureModel && typeof message.textureModel.length === 'number') ||
          $util.isString(message.textureModel)
        )
      )
    ...
    if (message.preview != null && message.hasOwnProperty('preview'))
      if (
        !(
          (message.preview && typeof message.preview.length === 'number') ||
          $util.isString(message.preview)
        )
      )
    ...
    if (message.meshBlob != null && message.hasOwnProperty('meshBlob'))
      if (
        !(
          (message.meshBlob && typeof message.meshBlob.length === 'number') ||
          $util.isString(message.meshBlob)
        )
      )
    ...
    if (message.textureBlob != null && message.hasOwnProperty('textureBlob'))
      if (
        !(
          (message.textureBlob && typeof message.textureBlob.length === 'number') ||
          $util.isString(message.textureBlob)
        )
      )
  ...
  ARModelData.fromObject = function fromObject(object) {
    if (object instanceof $root.ARModelData) return object;
    var message = new $root.ARModelData();
    if (object.meshModel != null)
      if (typeof object.meshModel === 'string')
        $util.base64.decode(
          object.meshModel,
          (message.meshModel = $util.newBuffer($util.base64.length(object.meshModel))),
          0
        );
      else if (object.meshModel.length) message.meshModel = object.meshModel;
    if (object.textureModel != null)
      if (typeof object.textureModel === 'string')
        $util.base64.decode(
          object.textureModel,
          (message.textureModel = $util.newBuffer($util.base64.length(object.textureModel))),
          0
        );
      else if (object.textureModel.length) message.textureModel = object.textureModel;
    if (object.preview != null)
      if (typeof object.preview === 'string')
        $util.base64.decode(
          object.preview,
          (message.preview = $util.newBuffer($util.base64.length(object.preview))),
          0
        );
      else if (object.preview.length) message.preview = object.preview;
    if (object.meshBlob != null)
      if (typeof object.meshBlob === 'string')
        $util.base64.decode(
          object.meshBlob,
          (message.meshBlob = $util.newBuffer($util.base64.length(object.meshBlob))),
          0
        );
      else if (object.meshBlob.length) message.meshBlob = object.meshBlob;
    if (object.textureBlob != null)
      if (typeof object.textureBlob === 'string')
        $util.base64.decode(
          object.textureBlob,
          (message.textureBlob = $util.newBuffer($util.base64.length(object.textureBlob))),
          0
        );
      else if (object.textureBlob.length) message.textureBlob = object.textureBlob;
    return message;
  };
  ...
  ARModelData.toObject = function toObject(message, options) {
    ...
    var object = {};
    if (options.defaults) {
      if (options.bytes === String) object.meshModel = '';
      else {
        object.meshModel = [];
        if (options.bytes !== Array) object.meshModel = $util.newBuffer(object.meshModel);
      }
      if (options.bytes === String) object.textureModel = '';
      else {
        object.textureModel = [];
        if (options.bytes !== Array) object.textureModel = $util.newBuffer(object.textureModel);
      }
      if (options.bytes === String) object.preview = '';
      else {
        object.preview = [];
        if (options.bytes !== Array) object.preview = $util.newBuffer(object.preview);
      }
      if (options.bytes === String) object.meshBlob = '';
      else {
        object.meshBlob = [];
        if (options.bytes !== Array) object.meshBlob = $util.newBuffer(object.meshBlob);
      }
      if (options.bytes === String) object.textureBlob = '';
      else {
        object.textureBlob = [];
        if (options.bytes !== Array) object.textureBlob = $util.newBuffer(object.textureBlob);
      }
    }
    if (message.meshModel != null && message.hasOwnProperty('meshModel'))
      object.meshModel =
        options.bytes === String
          ? $util.base64.encode(message.meshModel, 0, message.meshModel.length)
          : options.bytes === Array
            ? Array.prototype.slice.call(message.meshModel)
            : message.meshModel;
    if (message.textureModel != null && message.hasOwnProperty('textureModel'))
      object.textureModel =
        options.bytes === String
          ? $util.base64.encode(message.textureModel, 0, message.textureModel.length)
          : options.bytes === Array
            ? Array.prototype.slice.call(message.textureModel)
            : message.textureModel;
    if (message.preview != null && message.hasOwnProperty('preview'))
      object.preview =
        options.bytes === String
          ? $util.base64.encode(message.preview, 0, message.preview.length)
          : options.bytes === Array
            ? Array.prototype.slice.call(message.preview)
            : message.preview;
    if (message.meshBlob != null && message.hasOwnProperty('meshBlob'))
      object.meshBlob =
        options.bytes === String
          ? $util.base64.encode(message.meshBlob, 0, message.meshBlob.length)
          : options.bytes === Array
            ? Array.prototype.slice.call(message.meshBlob)
            : message.meshBlob;
    if (message.textureBlob != null && message.hasOwnProperty('textureBlob'))
      object.textureBlob =
        options.bytes === String
          ? $util.base64.encode(message.textureBlob, 0, message.textureBlob.length)
          : options.bytes === Array
            ? Array.prototype.slice.call(message.textureBlob)
            : message.textureBlob;
    return object;
  };
...
$root.GetARModelReq = (function () {
  ...
  GetARModelReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GetARModelReq();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GetARModelReq.verify = function verify(message) {
    ...
    if (message.cosid != null && message.hasOwnProperty('cosid'))
      if (!$util.isString(message.cosid)) return 'cosid: string expected';
    if (message.modelType != null && message.hasOwnProperty('modelType'))
      if (!$util.isInteger(message.modelType)) return 'modelType: integer expected';
    if (message.needData != null && message.hasOwnProperty('needData'))
      if (!$util.isInteger(message.needData)) return 'needData: integer expected';
    if (message.useIntranet != null && message.hasOwnProperty('useIntranet'))
      if (!$util.isInteger(message.useIntranet)) return 'useIntranet: integer expected';
  ...
  GetARModelReq.fromObject = function fromObject(object) {
    if (object instanceof $root.GetARModelReq) return object;
    var message = new $root.GetARModelReq();
    if (object.bizuin != null) message.bizuin = object.bizuin >>> 0;
    if (object.cosid != null) message.cosid = String(object.cosid);
    if (object.modelType != null) message.modelType = object.modelType >>> 0;
    if (object.needData != null) message.needData = object.needData >>> 0;
    if (object.useIntranet != null) message.useIntranet = object.useIntranet >>> 0;
    if (object.expireTime != null) message.expireTime = object.expireTime >>> 0;
    return message;
  };
...
$root.GetARModelResp = (function () {
  ...
  GetARModelResp.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GetARModelResp();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  GetARModelResp.verify = function verify(message) {
    ...
    if (message.modelData != null && message.hasOwnProperty('modelData')) {
      ...
      if (error) return 'modelData.' + error;
    }
    if (message.url != null && message.hasOwnProperty('url'))
      if (!$util.isString(message.url)) return 'url: string expected';
    if (message.host != null && message.hasOwnProperty('host'))
  ...
  GetARModelResp.fromObject = function fromObject(object) {
    if (object instanceof $root.GetARModelResp) return object;
