module.exports = /******/ (function (modules) {
  ...
  \**********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const callWXInnerAPI_1 = __webpack_require__(
          /*! ./callWXInnerAPI */ './src/api/inner/api/callWXInnerAPI.ts'
        );
        const callWXSvrkit_1 = __webpack_require__(
          /*! ./callWXSvrkit */ './src/api/inner/api/callWXSvrkit.ts'
        );
        const callSvrkit_1 = __webpack_require__(
          /*! ./callSvrkit */ './src/api/inner/api/callSvrkit.ts'
        );
        const callTencentInnerAPI_1 = __webpack_require__(
          /*! ./callTencentInnerAPI */ './src/api/inner/api/callTencentInnerAPI.ts'
        );
  ...
  \*****************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const openapi_1 = __webpack_require__(
          /*! ../../../protobuf/openapi */ './src/protobuf/openapi.js'
        );
        const error_config_1 = __webpack_require__(
          /*! config/error.config */ './src/config/error.config.ts'
        );
        ...
        function getCallSvrkit(cloud) {
          return function callSvrkit(options) {
            return new Promise(async (resolve, reject) => {
              if (!options) {
                return reject(
                  error_1.returnAsFinalCloudSDKError(
                    {
                      errMsg:
                        'Params for callSvrkit must be an object instead of ' + typeof options,
                    },
                    API_NAME
                  )
                );
                ...
                if (wxResp) {
                  if (wxResp.errorCode) {
                    ...
                    throw new error_1.CloudSDKError({
                      errCode:
                        error_config_1.ERR_CODE[error_config_1.ERR_CODE[wxResp.errorCode]] ||
                        wxResp.errorCode,
                    ...
                    if (options.convertResp && options.convertResp.bytes === false) {
                      if (!options.pbInstance.resProto) {
                        throw new Error(
                          "please ensure 'pbInstance' is generated using @tencent/cloud-functions-tools whose version is greater or equal to 1.3.0"
                        );
                      }
              ...
              if (!options) {
                return reject(
                  error_1.returnAsFinalCloudSDKError(
                    {
                      errMsg:
                        'Params for callTencentInnerAPI must be an object instead of ' +
                        typeof options,
                    },
                    apiName
                  )
                  ...
                  if (options.autoParse) {
                    if (/application\/json/.test(wxResp.contentType)) {
                      ...
                      try {
                        ...
                        throw new error_1.CloudSDKError({
                          errCode: error_config_1.ERR_CODE.WX_SYSTEM_ERROR,
                          errMsg: msg_1.apiFailMsg(
                            API_NAME,
                            `response body is not a valid json: ${wxResp.respData.toString()}`
                          ),
                        });
                      }
              ...
              if (!options) {
                return reject(
                  error_1.returnAsFinalCloudSDKError(
                    {
                      errMsg:
                        'Params for callWXInnerAPI must be an object instead of ' + typeof options,
                    },
                    apiName
                  )
                );
            ...
            return new Promise(async (resolve, reject) => {
              if (!options) {
                return reject(
                  error_1.returnAsFinalCloudSDKError(
                    {
                      errMsg:
                        'Params for callWXSvrkit must be an object instead of ' + typeof options,
                    },
                    apiName
                  )
                );
              ...
              try {
                ...
                if (parsedResult.ret === 0) {
                  parsedResult.respBodyBuffer = Buffer.from(
                    parsedResult.resp_body_buffer,
                    'base64'
                  );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class MidasSignature {
          ...
          compute(cgiPath, method, secret, paramValues) {
            ...
            const paramNames = [...this.params].sort().map(name =>
              utils_1.convertCase(name, {
                from: 'camelcase',
                to: 'snakecase',
              })
            );
  ...
  \************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.ERR_CODE = {
          ...
          '-404008':
            'error while polling for the result, polling server return a status code of %s',
            ...
            if (message.apiType != null && message.hasOwnProperty('apiType'))
              object.apiType =
                options.enums === String
                  ? $root.CommApiData.ApiType[message.apiType]
                  : message.apiType;
            if (message.openapiData != null && message.hasOwnProperty('openapiData'))
        ...
        $root.CommOpenApiResp = (function () {
          ...
          CommOpenApiResp.verify = function verify(message) {
            ...
            if (message.respData != null && message.hasOwnProperty('respData'))
              if (
                !(
                  (message.respData && typeof message.respData.length === 'number') ||
                  $util.isString(message.respData)
                )
              )
          ...
          CommOpenApiResp.fromObject = function fromObject(object) {
            ...
            if (object.respData != null)
              if (typeof object.respData === 'string')
                $util.base64.decode(
                  object.respData,
                  (message.respData = $util.newBuffer($util.base64.length(object.respData))),
                  0
                );
          ...
          CommOpenApiResp.toObject = function toObject(message, options) {
            ...
            if (message.respData != null && message.hasOwnProperty('respData'))
              object.respData =
                options.bytes === String
                  ? $util.base64.encode(message.respData, 0, message.respData.length)
                  : options.bytes === Array
                    ? Array.prototype.slice.call(message.respData)
                    : message.respData;
            if (message.contentType != null && message.hasOwnProperty('contentType'))
              object.contentType = message.contentType;
            if (message.errorCode != null && message.hasOwnProperty('errorCode'))
        ...
        $root.InnerApiData = (function () {
          ...
          InnerApiData.verify = function verify(message) {
            ...
            if (message.headers != null && message.hasOwnProperty('headers')) {
              if (!Array.isArray(message.headers)) return 'headers: array expected';
              for (var i = 0; i < message.headers.length; ++i)
                if (!$util.isString(message.headers[i])) return 'headers: string[] expected';
            }
            if (message.body != null && message.hasOwnProperty('body'))
              if (
                !(
          ...
          InnerApiData.toObject = function toObject(message, options) {
            ...
            if (message.method != null && message.hasOwnProperty('method'))
              object.method =
                options.enums === String ? $root.HTTP_METHODS[message.method] : message.method;
            if (message.headers && message.headers.length) {
              object.headers = [];
              for (var j = 0; j < message.headers.length; ++j)
        ...
        $root.SvrkitApiData = (function () {
          ...
          SvrkitApiData.verify = function verify(message) {
            ...
            if (message.reqData != null && message.hasOwnProperty('reqData'))
              if (
                !(
                  (message.reqData && typeof message.reqData.length === 'number') ||
                  $util.isString(message.reqData)
                )
              )
          ...
          SvrkitApiData.fromObject = function fromObject(object) {
            ...
            if (object.reqData != null)
              if (typeof object.reqData === 'string')
                $util.base64.decode(
                  object.reqData,
                  (message.reqData = $util.newBuffer($util.base64.length(object.reqData))),
                  0
                );
          ...
          SvrkitApiData.toObject = function toObject(message, options) {
            ...
            if (message.reqData != null && message.hasOwnProperty('reqData'))
              object.reqData =
                options.bytes === String
                  ? $util.base64.encode(message.reqData, 0, message.reqData.length)
                  : options.bytes === Array
                    ? Array.prototype.slice.call(message.reqData)
                    : message.reqData;
            return object;
          };
        ...
        $root.ApiGetOpenDataByCloudIdResp = (function () {
          ...
          ApiGetOpenDataByCloudIdResp.encode = function encode(message, writer) {
            ...
            if (message.dataList != null && message.dataList.length)
              for (var i = 0; i < message.dataList.length; ++i)
                $root.ApiGetOpenDataByCloudIdResp.OpDataItem.encode(
                  message.dataList[i],
                  writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
                ).ldelim();
            return writer;
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1:
                  ...
                  message.dataList.push(
                    $root.ApiGetOpenDataByCloudIdResp.OpDataItem.decode(reader, reader.uint32())
                  );
                  break;
                default:
                  reader.skipType(tag & 7);
          ...
          ApiGetOpenDataByCloudIdResp.verify = function verify(message) {
            ...
            if (message.dataList != null && message.hasOwnProperty('dataList')) {
              ...
              for (var i = 0; i < message.dataList.length; ++i) {
                var error = $root.ApiGetOpenDataByCloudIdResp.OpDataItem.verify(
                  message.dataList[i]
                );
          ...
          ApiGetOpenDataByCloudIdResp.fromObject = function fromObject(object) {
            ...
            if (object.dataList) {
              ...
              for (var i = 0; i < object.dataList.length; ++i) {
                ...
                message.dataList[i] = $root.ApiGetOpenDataByCloudIdResp.OpDataItem.fromObject(
                  object.dataList[i]
                );
              }
            }
          ...
          ApiGetOpenDataByCloudIdResp.toObject = function toObject(message, options) {
            ...
            if (message.dataList && message.dataList.length) {
              ...
              for (var j = 0; j < message.dataList.length; ++j)
                object.dataList[j] = $root.ApiGetOpenDataByCloudIdResp.OpDataItem.toObject(
                  message.dataList[j],
                  options
                );
            }
        ...
        $root.AuthorizationInfo = (function () {
          ...
          AuthorizationInfo.encode = function encode(message, writer) {
            ...
            if (message.tcbCredentials != null && message.hasOwnProperty('tcbCredentials'))
              $root.AuthorizationInfo.TcbCredentials.encode(
                message.tcbCredentials,
                writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
              ).ldelim();
          ...
          AuthorizationInfo.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1:
                  message.tcbCredentials = $root.AuthorizationInfo.TcbCredentials.decode(
                    reader,
                    reader.uint32()
                  );
                  break;
          ...
          AuthorizationInfo.verify = function verify(message) {
            ...
            if (message.wxParam != null && message.hasOwnProperty('wxParam'))
              if (
                !(
                  (message.wxParam && typeof message.wxParam.length === 'number') ||
                  $util.isString(message.wxParam)
                )
              )
          ...
          AuthorizationInfo.fromObject = function fromObject(object) {
            ...
            if (object.tcbCredentials != null) {
              ...
              message.tcbCredentials = $root.AuthorizationInfo.TcbCredentials.fromObject(
                object.tcbCredentials
              );
            }
            if (object.wxParam != null)
              if (typeof object.wxParam === 'string')
                $util.base64.decode(
                  object.wxParam,
                  (message.wxParam = $util.newBuffer($util.base64.length(object.wxParam))),
                  0
                );
          ...
          AuthorizationInfo.toObject = function toObject(message, options) {
            ...
            if (message.tcbCredentials != null && message.hasOwnProperty('tcbCredentials'))
              object.tcbCredentials = $root.AuthorizationInfo.TcbCredentials.toObject(
                message.tcbCredentials,
                options
              );
            if (message.wxParam != null && message.hasOwnProperty('wxParam'))
              object.wxParam =
                options.bytes === String
                  ? $util.base64.encode(message.wxParam, 0, message.wxParam.length)
                  : options.bytes === Array
                    ? Array.prototype.slice.call(message.wxParam)
                    : message.wxParam;
            return object;
          };
          ...
          AuthorizationInfo.WxParam = (function () {
            ...
            WxParam.verify = function verify(message) {
              ...
              if (message.qbaseTicket != null && message.hasOwnProperty('qbaseTicket'))
                if (
                  !(
                    (message.qbaseTicket && typeof message.qbaseTicket.length === 'number') ||
                    $util.isString(message.qbaseTicket)
                  )
                )
            ...
            WxParam.fromObject = function fromObject(object) {
              ...
              if (object.qbaseTicket != null)
                if (typeof object.qbaseTicket === 'string')
                  $util.base64.decode(
                    object.qbaseTicket,
                    (message.qbaseTicket = $util.newBuffer(
                      $util.base64.length(object.qbaseTicket)
                    )),
                    0
                  );
            ...
            WxParam.toObject = function toObject(message, options) {
              ...
              if (message.qbaseTicket != null && message.hasOwnProperty('qbaseTicket'))
                object.qbaseTicket =
                  options.bytes === String
                    ? $util.base64.encode(message.qbaseTicket, 0, message.qbaseTicket.length)
                    : options.bytes === Array
                      ? Array.prototype.slice.call(message.qbaseTicket)
                      : message.qbaseTicket;
              if (message.authUin != null && message.hasOwnProperty('authUin'))
  ...
  \*****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.assertObjectNotEmpty =
          exports.assertRequiredParam =
          exports.assertObjectOptionalType =
          exports.assertType =
          exports.validObjectOptionalType =
          exports.validType =
          exports.sameType =
            void 0;
        ...
        function assertObjectOptionalType(
          param,
          ref,
          name = 'parameter',
...
*/
  ...
  \****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.toSDKError =
          exports.returnAsFinalCloudSDKError =
          exports.returnAsCloudSDKError =
          exports.isSDKError =
          exports.createError =
          exports.CloudSDKError =
            void 0;
        const type_1 = __webpack_require__(/*! ./type */ './src/utils/type.ts');
        const error_config_1 = __webpack_require__(
          /*! config/error.config */ './src/config/error.config.ts'
          ...
          constructor(options) {
            ...
            Object.defineProperties(this, {
              message: {
                get() {
                  return (
                    `errCode: ${this.errCode} ${error_config_1.ERR_CODE[this.errCode] || ''} | errMsg: ` +
                    this.errMsg
                  );
                },
                set(msg) {
        ...
        function returnAsCloudSDKError(err, appendMsg = '') {
          if (err) {
            ...
            const errMsg =
              ((err && err.errMsg) || err.toString() || 'unknown error') + '; ' + appendMsg;
        ...
        function toSDKError(e, apiName) {
          if (e) {
            ...
            if (e instanceof Error) {
              ...
              err = new Error(
                `${apiName}:fail ${e.errCode} ${error_config_1.ERR_CODE[e.errCode] || ''}. ${errMsg}`
              );
  ...
  \****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.getMergedAPIConfig =
          exports.getServiceConfigFromDefaultConfig =
          exports.getEnvFromAPIConfig =
          exports.getEnvFromCloudConfig =
          exports.isSCFEnvReady =
          exports.convertCase =
            void 0;
        const type_1 = __webpack_require__(/*! ./type */ './src/utils/type.ts');
        const signature_1 = __webpack_require__(
          /*! api/utils/api/signature */ './src/api/utils/api/signature.ts'
        );
        ...
        exports.convertCase = (input, options) => {
          ...
          if (type_1.isString(input)) {
            if (from === 'camelcase' && to === 'snakecase') {
              return input.replace(
                /[A-Z]/g,
                (match, ind) => `${ind ? '_' : ''}${match.toLowerCase()}`
              );
          ...
          function convertObject(input) {
            ...
            for (const key in data) {
              const val =
                recursive && (type_1.isObject(data[key]) || type_1.isArray(data[key]))
                  ? exports.convertCase(data[key], options)
                  : data[key];
