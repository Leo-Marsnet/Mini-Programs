...
$root.ApiDemoReq = (function () {
  ...
  ApiDemoReq.fromObject = function fromObject(object) {
    if (object instanceof $root.ApiDemoReq) return object;
  ...
  ApiDemoReq.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.str = '';
    if (message.str != null && message.hasOwnProperty('str')) object.str = message.str;
    return object;
  };
...
$root.ApiDemoResp = (function () {
  ...
  ApiDemoResp.fromObject = function fromObject(object) {
    if (object instanceof $root.ApiDemoResp) return object;
...
$root.GenWxaCloudTmpCodeReq = (function () {
  ...
  GenWxaCloudTmpCodeReq.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected';
    if (message.CloudPlatform != null && message.hasOwnProperty('CloudPlatform'))
      if (!$util.isInteger(message.CloudPlatform)) return 'CloudPlatform: integer expected';
    if (message.AppUin != null && message.hasOwnProperty('AppUin'))
      if (!$util.isInteger(message.AppUin)) return 'AppUin: integer expected';
    if (message.UserUin != null && message.hasOwnProperty('UserUin'))
      if (!$util.isInteger(message.UserUin)) return 'UserUin: integer expected';
    return null;
  };
...
$root.GenWxaCloudTmpCodeResp = (function () {
  ...
  GenWxaCloudTmpCodeResp.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected';
    if (message.TmpCode != null && message.hasOwnProperty('TmpCode'))
      if (!$util.isString(message.TmpCode)) return 'TmpCode: string expected';
    return null;
  };
...
$root.WeAppMemberInfo = (function () {
  ...
  WeAppMemberInfo.verify = function verify(message) {
    ...
    if (message.type != null && message.hasOwnProperty('type'))
      if (!$util.isInteger(message.type)) return 'type: integer expected';
    if (message.weappuin != null && message.hasOwnProperty('weappuin'))
      if (!$util.isInteger(message.weappuin)) return 'weappuin: integer expected';
    if (message.useruin != null && message.hasOwnProperty('useruin'))
      if (!$util.isInteger(message.useruin)) return 'useruin: integer expected';
    if (message.status != null && message.hasOwnProperty('status'))
      if (!$util.isInteger(message.status)) return 'status: integer expected';
    ...
    if (message.ticket != null && message.hasOwnProperty('ticket'))
      if (!$util.isString(message.ticket)) return 'ticket: string expected';
    return null;
  };
